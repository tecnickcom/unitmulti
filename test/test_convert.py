...
class TestProcess(TestCase):
    ...
    def test_get_value_multiple(self):
        ...
        for value, step, expvalue, expmultiple in data:
            self.assertEqual(self.cnv.get_value_multiple(value, step), (expvalue, expmultiple))
    ...
    def test_get_iec_value_multiple(self):
        ...
        for value, expvalue, expmultiple in data:
            self.assertEqual(self.cnv.get_iec_value_multiple(value), (expvalue, expmultiple))
    ...
    def test_get_si_value_multiple(self):
        ...
        for value, unit, expvalue, expunit in data:
            self.assertEqual(self.cnv.get_si_value_multiple(value, unit), (expvalue, expunit))
    ...
    def test_get_value_submultiple(self):
        ...
        for value, unit, expvalue, expunit in data:
            self.assertEqual(self.cnv.get_value_submultiple(value, unit), (expvalue, expunit))
